...
(:mod:`gymnastics.cycle_alignment.cycles`, right-wrist azimuth in the body frame).
...
def fused_wrist_theta(
    ...
    *,
    ...
    Returns:
        ``[T]`` unwrapped angle.
    """
    from gymnastics.cycle_alignment.main import IDX, kpts_world_to_body
...
## Definition (shared by every dataset, `src/gymnastics/cycle_alignment/cycles.py`)

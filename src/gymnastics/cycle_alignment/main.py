...
from gymnastics.cycle_alignment.load import load_sam3d_body_sequence
from gymnastics.cycle_alignment.save import save_cycles_videos
...
def segment_cycles_from_fused_body(
    ...
    *,
    ...
    The detection itself lives in :mod:`gymnastics.cycle_alignment.cycles`; this
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=int,
        help="Legacy positional thread count, e.g. gymnastics align 11",
    )
...
def cli_main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    if argv_list and argv_list[0] == "cycles":
        ...
        from gymnastics.cycle_alignment.annotate_cycles import main as annotate_main

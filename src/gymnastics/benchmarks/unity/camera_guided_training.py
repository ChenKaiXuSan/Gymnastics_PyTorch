...
from gymnastics.archive.rotation_aware.camera import CameraFeatureBundle
from gymnastics.keypoints.config import (
    SkeletonSpec,
    load_skeleton_spec,
)
...
from gymnastics.archive.rotation_aware.training import train_one_epoch

...
from gymnastics.triangulation.camera_position_mapping import prepare_camera_position
from gymnastics.triangulation.load import load_keypoints_from_npz, load_kpt_and_bbox_from_d2_pt
from gymnastics.triangulation.visualization.frame_visualization import draw_and_save_keypoints_from_frame
from gymnastics.triangulation.visualization.pose_visualization import draw_camera, visualize_3d_joints
from gymnastics.triangulation.visualization.merge_video import merge_frames_to_video
from gymnastics.triangulation.save import save_3d_joints
...
@hydra.main(
    version_base=None,
    config_path="../../../configs/triangulation",
    config_name="legacy",
)
def main(cfg):

...
from gymnastics.fusion.deterministic.load import load_fused_frame, load_fused_sequence, get_fused_frame_mapping
...
def example_load_single_frame():
    ...
    person_id = "1"
    person_root = Path(f"local/runs/fuse/person_{person_id}")
    frame_idx = 50

...
class CalibConfig:
    ...
    output_dir: str = "local/runs/calibration_vis"
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--input",
        type=str,
        default="local/calibration_inputs",
    ...
    p.add_argument(
        "--step", type=int, default=30, help="Frame sampling step for video"
    )
    p.add_argument("--out_dir", type=str, default="local/runs/calibration_vis")

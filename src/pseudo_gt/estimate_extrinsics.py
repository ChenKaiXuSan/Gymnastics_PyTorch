...
(``camera_position`` in ``src/configs/pseudo_gt/sam3d_triangulation.yaml``: four cameras on a
...
def draw_recovered_rigs(
    ...
    """
    from pseudo_gt.camera_position_mapping import Extrinsics, draw_cameras_matplotlib
...
def assumed_relative_pose(cfg: Dict[str, Any]) -> Tuple[np.ndarray, np.ndarray]:
    ...
    from pseudo_gt.camera_position_mapping import (
        angles_to_position,

...
``EvaluationConfig`` (``src/configs/fusion/evaluation``) sets the failure
...
class OptimizerConfig:
    """Optimiser and schedule settings (``src/configs/fusion/trainer``).
...
class EvaluationConfig:
    """Optional diagnostics (``src/configs/fusion/evaluation``).

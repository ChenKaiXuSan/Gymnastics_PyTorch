...
This module holds the parser, the configuration helpers and the evaluation-only
stages (inspect, infer, triangulate, fuse, evaluate, run). The training-stage
families live in ``stages_supervised``, ``stages_extrinsic`` and
``stages_camera_feature`` and are dispatched from :func:`main`.
"""
...
from .camera_guided_data import CAMERA_GUIDED_ABLATIONS
from .dataset import (
...
from .extrinsic_training import EXTRINSIC_METHODS
from .fusion import (
...
from fusion.benchmarks.unity.stages_camera_feature import (
    _evaluate_camera_feature,
    _train_camera_feature,
    _train_camera_feature_matrix,
)
from fusion.benchmarks.unity.stages_extrinsic import (
    _evaluate_extrinsic,
    _report_extrinsic,
    _train_extrinsic,
    _train_extrinsic_matrix,
)
from fusion.benchmarks.unity.stages_supervised import (
    _evaluate_finetuned,
    _finetune,
    _finetune_matrix,
    _report_finetuned,
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m fusion benchmark-unity",

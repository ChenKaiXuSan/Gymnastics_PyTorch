...
from pseudo_gt.estimate_extrinsics import (
    _camera_frame_3d,
    _valid_mask,
    assumed_relative_pose,
    undistort,
)
from pseudo_gt.sam3d_from_split_cycle import (
    load_calibration,
    load_sam3d_output,
    sam3d_frame_path,
    save_frame_json,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", default="src/configs/pseudo_gt/sam3d_triangulation.yaml")
    parser.add_argument(
        "--extrinsics", default="local/runs/analysis/extrinsics/estimated_extrinsics.json"
    )
    parser.add_argument("--max-frames", type=int, default=80, help="Frames scored per person.")
    parser.add_argument("--workers", type=int, default=16)
    parser.add_argument("--output-dir", default="local/runs/analysis/extrinsics")
...
def main() -> None:
    ...
    lines = [
        ...
        "`src/configs/pseudo_gt/sam3d_triangulation.yaml` (face/side 90 deg apart, 4.95 m baseline), "

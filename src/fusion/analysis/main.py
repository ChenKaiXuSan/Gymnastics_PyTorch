...
from common.paths import RUN_ROOT
from fusion.analysis.metrics import (
    MHR70_INDEX,
    compute_twist,
    compute_trunk_tilt,
    compute_wrist_lead_angle,
)
from fusion.analysis.visualize import (
    plot_all_visualizations,
    plot_derived_metrics_summary,
)
from fusion.baselines.load import load_fused_sequence as _load_fused_seq
...
def analyze_sequence(
    ...
    if output_dir is None:
        output_dir = RUN_ROOT / "analysis" / f"person_{person_id}"
...
def main():
    """主函数"""
    fuse_root = (RUN_ROOT / "fuse").resolve()
    output_root = (RUN_ROOT / "analysis").resolve()

...
def load_fused_frame(frame_path: Union[str, Path]) -> Dict:
    ...
    """
    from fusion.baselines.load import load_fused_frame as _load_frame
...
def load_fused_sequence(
    ...
    Args:
        person_id: 人物ID
        person_root: 人物根目录，None则使用默认路径 local/runs/fuse/person_{id}
    ...
    Returns:
        ...
        metadata: 元数据字典
    """
    from fusion.baselines.load import load_fused_sequence as _load_sequence
...
def get_fused_frame_mapping(
    ...
    """
    from fusion.baselines.load import get_fused_frame_mapping as _get_mapping

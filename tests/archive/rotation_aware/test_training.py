...
import gymnastics.archive.rotation_aware.training as training_module
from gymnastics.keypoints.config import RoleSpec, SkeletonSpec
from gymnastics.archive.rotation_aware.dataset import collate_pose_pair_windows
...
from gymnastics.archive.rotation_aware.prefetch import ThroughputConfig, ordered_prefetch, pin_tensor_batch
from gymnastics.archive.rotation_aware.profiling import StageProfiler
from gymnastics.archive.rotation_aware.training import TrainingTrace, _corrupt_batch, _feature_bundle, _forward_window, _fused_bone_cv, _prepare_window, _tensor_batch, load_checkpoint, prepare_validation_batches, save_checkpoint, train_one_epoch, train_one_epoch_reference, validate
...
def test_validation_score_and_checkpoint_metadata_exclude_external_ground_truth(tmp_path: Path) -> None:
    ...
    save_checkpoint(
        ...
        corruption_config=__import__("gymnastics.archive.rotation_aware.corruptions", fromlist=["CorruptionConfig"]).CorruptionConfig(),

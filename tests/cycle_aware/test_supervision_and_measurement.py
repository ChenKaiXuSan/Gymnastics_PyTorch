...
from gymnastics.fusion.cycle_aware.lightning_module import CycleAwareFusionModule, EvaluationConfig
from gymnastics.fusion.cycle_aware.losses import LossConfig, compute_losses, half_symmetry_loss, reference_target
from gymnastics.fusion.cycle_aware.measurement import retention_ratios, trunk_twist
...
def test_train_with_reference_and_gymnastics_refusal(tmp_path: Path):
    ...
    from gymnastics.fusion.cycle_aware.data.gymnastics import GymnasticsDataModule

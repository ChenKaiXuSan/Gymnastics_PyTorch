...
from gymnastics.fusion.cycle_aware.corruptions import CorruptionConfig
from gymnastics.fusion.cycle_aware.data import build_datamodule
from gymnastics.fusion.cycle_aware.data.base import DataConfig, SplitSpec
from gymnastics.fusion.cycle_aware.data.synthetic import SyntheticDataModule
from gymnastics.fusion.cycle_aware.data.windows import CycleWindowDataset, WindowConfig, window_starts
from gymnastics.fusion.cycle_aware.sample import collate_fusion_batch
...
def test_window_dataset_rejects_wrong_skeleton(skeleton):
    from gymnastics.fusion.cycle_aware.skeleton import build_common_skeleton
...
def test_sample_cache_round_trip(tmp_path, skeleton):
    from gymnastics.fusion.cycle_aware.data.sample_cache import load_samples, save_samples
...
def test_full_context_window_is_one_window_per_sequence(skeleton):
    ...
    from gymnastics.fusion.cycle_aware.model import CycleAwareModelConfig

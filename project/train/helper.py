...
# -*- coding:utf-8 -*-
"""
File: /workspace/code/project/helper.py
...
-----
Last Modified: Thursday April 16th 2026 9:20:37 pm
...
def save_CM(
    ...
    logger.info(
        f"save the confusion matrix into {save_path}/{fold}_confusion_matrix.png"
    )

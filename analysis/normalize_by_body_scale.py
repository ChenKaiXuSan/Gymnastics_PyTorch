...
similarity-aligned MPJPE in ``logs/fuse_experiments`` is off by the same ``s`` --
...
DEFAULT_METRICS = Path("logs/fuse_experiments/metrics_by_person.csv")
DEFAULT_OUT_DIR = Path("logs/analysis/body_scale_normalized")
